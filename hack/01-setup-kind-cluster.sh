#!/usr/bin/env bash
# Create a local kind cluster with Konfidence installed, for trying the
# example app. Cluster creation is ours; the Konfidence install is delegated
# to the official quickstart installer from the konfidence repo.
#
# Env:
...
echo "    Next: REGISTRY=<your-registry> ./hack/02-pipeline.sh"
