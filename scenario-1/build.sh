...
echo "Starting Scenario 1 build and push..."
...
for component in "${COMPONENTS[@]}"; do
    ...
    oras push "${REMOTE_REPO}/kustomizations/${component}:v0.0.3" \
...
echo "Scenario 1 build and push completed successfully!"
echo
echo "Verify with:"
echo "  oras repo tags ${REMOTE_REPO}/kustomizations/productpage-v1"
